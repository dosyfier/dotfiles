...
# COLORS from mocha catppuccin terminal theme
thm_bg="#1e1e2e"
thm_fg="#cdd6f4"
rosewater="#f5e0dc"
flamingo="#f2cdcd"
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		...
		# "vcs_compare $thm_gray"
		# "vcs_staged $thm_gray"
		# "vcs_modified $thm_gray"
		# "vcs_others $thm_gray"
	)
fi
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		#"xkb_layout 125 117"
		"date_day $green $thm_bg"
		"date $green $thm_bg ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"time $green $thm_bg ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
