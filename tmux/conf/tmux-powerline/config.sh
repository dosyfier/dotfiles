...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="mocha-bubble"
	...
	export TMUX_POWERLINE_STATUS_JUSTIFICATION="center"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/dosyfier/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/dosyfier/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/dosyfier/.now_playing.log"
